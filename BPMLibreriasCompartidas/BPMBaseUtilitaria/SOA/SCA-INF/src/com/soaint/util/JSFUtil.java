...
public class JSFUtil {
    ...
    public static String getStringFromBundle(String bundle, String key) {
        PropertyResourceBundle resb =
            (PropertyResourceBundle)ResourceBundle.getBundle(bundle);
        if (resb != null)
...
*/
    ...
    public static Object getBackingBean(String name) {
        ...
        if (bean == null) {
            FacesContext facescontext = FacesContext.getCurrentInstance();
            bean =
facescontext.getApplication().createValueBinding("#{" + name +
                                                 "}").getValue(facescontext); //$NON-NLS-1$ //$NON-NLS-2$
        }
        return bean;
    }
    ...
    public static String handleNavigation(String page,
                                          String pageWithExtention) {
    ...
    public static void refreshComponent(UIComponent comp) {
